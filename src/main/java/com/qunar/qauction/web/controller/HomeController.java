...
public class HomeController {
     ...
     */
    @JsonBody @RequestMapping(value = "/index/queryAuctioning", method = RequestMethod.GET) public List<AuctioningVo> queryAuctioningVoByState(
    ...
    public List<AuctioningVo> queryItemByCategory(Integer categoryId, Integer currentPage, Integer pageSize) {
