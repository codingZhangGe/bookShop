...
<body>
	书籍id:<input type="text" name="na_id" id="id_id" /><br><br>
	...
	状态：<select name="na_state" id="id_state">
			<option value="1" checked="checked" >待销</option>
			<option value="2">售空</option>
		</select>
	数量：<input type="text" name="na_count" id="id_count" /><br><br>
	已售:<input type="text" name="na_sale" id="id_sale" /><br><br>
...
<script type="text/javascript">
	function isButton(){
		...
		window.opener.setBook("select",valueList);
		window.close();
